...
class TestElectricChillers(unittest.TestCase):
    ...
    def test_populate_data_elements_with_centrif_chiller(self):
        ...
        expected_data_structure = {
            ...
            "rated_capacity": 125344.671875,
            "design_capacity": 158091.265625,
            "design_flow_condenser": 37.681522369384766,
            "design_flow_evaporator": 30.145217895507812,
        ...
        self.assertEqual(self.chiller.chiller_data_structure, expected_data_structure)
