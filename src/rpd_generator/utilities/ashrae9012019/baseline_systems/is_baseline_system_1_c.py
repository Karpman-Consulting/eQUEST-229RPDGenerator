...
def is_baseline_system_1_c(
    ...
    list of zones associated with the HVAC system to be evaluated. These are sent to this function from the is_baseline_system_1 function.
    ...
    list of purchased heating loop IDs associated with the HVAC system to be evaluated. These are sent to this function from the is_baseline_system_1 function.

    Returns
    -------
    true or false to whether the baseline system type is 1c (system 1 with purchased CHW and purchased HW).
    """
...
def diagnose_baseline_system_1_c(
    hvac,
    terminals_list,
    zones_list,
    purchased_cooling_loop_id_list,
