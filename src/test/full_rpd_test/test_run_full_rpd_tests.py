        ...
        self.assertEqual(
            {
                ...
                "North Door 1": "Prm Zone 3 North Wall Door 1",
                "North Door 2": "Prm Zone 3 North Wall Door 2",
                "North Window 1": "Prm Zone 3 North Wall Window 1",
                "North Window 2": "Prm Zone 3 North Wall Window 2",
                "North Window 3": "Prm Zone 3 North Wall Window 3",
                ...
                "East Door 1": "Prm Zone 2 East Wall Door 1",
                "East Window 1": "Prm Zone 2 East Wall Window 1",
                "East Window 2": "Prm Zone 2 East Wall Window 2",
                ...
                "South Door 1": "Prm Zone 1 South Wall Door 1",
                "South Door 2": "Prm Zone 1 South Wall Door 2",
                "South Window 1": "Prm Zone 1 South Wall Window 1",
                "South Window 2": "Prm Zone 1 South Wall Window 2",
                "South Window 3": "Prm Zone 1 South Wall Window 3",
                "Stucco": "Stucco",
                "West Door 1": "Prm Zone 4 West Wall Door 1",
                "West Window 1": "Prm Zone 4 West Wall Window 1",
                "West Window 2": "Prm Zone 4 West Wall Window 2",
            },
            object_id_map,
        )
        ...
        self.assertEqual(
            {
                ...
                "Core Zone 1 MainTerminal": "RPD_Test_System_P_PVAV_HW_Reheat_Baseboard - Terminal for Core Zone 1",
                "East Door 1": "Prm Zone 2 East Wall Door 1",
                "East Window 1": "Prm Zone 2 East Wall Window 1",
                "East Window 2": "Prm Zone 2 East Wall Window 2",
                "Exterior Wall Type 1": "Exterior Wall 1",
        ...
        self.assertEqual(
            {
                ...
                "Core Space 1 Slab on Grade": "Core Zone 1 Floor",
                "Core Zone 1": "Core Zone 1",
                "Core Zone 1 MainTerminal": "RPD_Test_System_1_PTAC - Terminal for Core Zone 1",
                "East Door 1": "Prm Zone 2 East Wall Door 1",
                "East Window 1": "Prm Zone 2 East Wall Window 1",
                "East Window 2": "Prm Zone 2 East Wall Window 2",
                "Exterior Wall Type 1": "Exterior Wall 1",
        ...
        self.assertEqual(
            {
                ...
                "Core Space 1 Slab on Grade": "Core Zone 1 Floor",
                "Core Zone 1": "Core Zone 1",
                "Core Zone 1 MainTerminal": "RPD_Test_System_2_PTHP - Terminal for Core Zone 1",
                "East Door 1": "Prm Zone 2 East Wall Door 1",
                "East Window 1": "Prm Zone 2 East Wall Window 1",
                "East Window 2": "Prm Zone 2 East Wall Window 2",
                "Exterior Wall Type 1": "Exterior Wall 1",
        ...
        self.assertEqual(
            {
                ...
                "Core Space 1 Slab on Grade": "Core Zone 1 Floor",
                "Core Zone 1": "Core Zone 1",
                "Core Zone 1 MainTerminal": "RPD_Test_System_3_PSZ_AC_Gas_Furnace - Terminal for Core Zone 1",
                "East Door 1": "Prm Zone 2 East Wall Door 1",
                "East Window 1": "Prm Zone 2 East Wall Window 1",
                "East Window 2": "Prm Zone 2 East Wall Window 2",
                "Exterior Wall Type 1": "Exterior Wall 1",
        ...
        self.assertEqual(
            {
                ...
                "Core Space 1 Slab on Grade": "Core Zone 1 Floor",
                "Core Zone 1": "Core Zone 1",
                "Core Zone 1 MainTerminal": "RPD_Test_System_5_PVAV_HW_Reheat - Terminal for Core Zone 1",
                "East Door 1": "Prm Zone 2 East Wall Door 1",
                "East Window 1": "Prm Zone 2 East Wall Window 1",
                "East Window 2": "Prm Zone 2 East Wall Window 2",
                "Exterior Wall Type 1": "Exterior Wall 1",
        ...
        self.assertEqual(
            {
                ...
                "Core Space 1 Slab on Grade": "Core Zone 1 Floor",
                "Core Zone 1": "Core Zone 1",
                "Core Zone 1 MainTerminal": "RPD_Test_System_6_PVAV_Elec_Reheat - Terminal for Core Zone 1",
                "East Door 1": "Prm Zone 2 East Wall Door 1",
                "East Window 1": "Prm Zone 2 East Wall Window 1",
                "East Window 2": "Prm Zone 2 East Wall Window 2",
                "Exterior Wall Type 1": "Exterior Wall 1",
                ...
                "Perimeter Space 4 Slab on Grade": "Prm Zone 4 Floor",
                "Prm Zone 1 (South) Zn": "Prm Zone 1 (South)",
                "Prm Zone 1 (South) Zn MainTerminal": "RPD_Test_System_6_PVAV_Elec_Reheat - Terminal for Prm Zone 1 (South)",
                "Prm Zone 2 (East) Zn": "Prm Zone 2 (East)",
                "Prm Zone 2 (East) Zn MainTerminal": "RPD_Test_System_6_PVAV_Elec_Reheat - Terminal for Prm Zone 2 (East)",
                "Prm Zone 3 (North)": "Prm Zone 3 (North)",
                "Prm Zone 3 (North) MainTerminal": "RPD_Test_System_6_PVAV_Elec_Reheat - Terminal for Prm Zone 3 (North)",
                "Prm Zone 4 (West)": "Prm Zone 4 (West)",
                "Prm Zone 4 (West) MainTerminal": "RPD_Test_System_6_PVAV_Elec_Reheat - Terminal for Prm Zone 4 (West)",
                "Roof Type 1": "Exterior Roof 1",
                "Roof Type 2": "Exterior Roof 2",
                "Roof Type 3": "Exterior Roof 3",
                "Slab-on-grade Type 1": "Slab On-grade 1",
        ...
        self.assertEqual(
            {
                ...
                "Core Space 1 Slab on Grade": "Core Zone 1 Floor",
                "Core Zone 1": "Core Zone 1",
                "Core Zone 1 MainTerminal": "RPD_Test_System_8_PFP_Reheat - Terminal for Core Zone 1",
                "East Door 1": "Prm Zone 2 East Wall Door 1",
                "East Window 1": "Prm Zone 2 East Wall Window 1",
                "East Window 2": "Prm Zone 2 East Wall Window 2",
                "Exterior Wall Type 1": "Exterior Wall 1",
        ...
        self.assertEqual(
            {
                ...
                "Core Space 1 Slab on Grade": "Core Zone 1 Floor",
                "Core Zone 1": "Core Zone 1",
                "Core Zone 1 MainTerminal": "RPD_Test_System_9_Warm_Air_Furnace_Gas - Terminal for Core Zone 1",
                "East Door 1": "Prm Zone 2 East Wall Door 1",
                "East Window 1": "Prm Zone 2 East Wall Window 1",
                "East Window 2": "Prm Zone 2 East Wall Window 2",
                "Exterior Wall Type 1": "Exterior Wall 1",
        ...
        self.assertEqual(
            {
                ...
                "Core Space 1 Slab on Grade": "Core Zone 1 Floor",
                "Core Zone 1": "Core Zone 1",
                "Core Zone 1 MainTerminal": "RPD_Test_System_10_Warm_air_Furnace_Elec - Terminal for Core Zone 1",
                "East Door 1": "Prm Zone 2 East Wall Door 1",
                "East Window 1": "Prm Zone 2 East Wall Window 1",
                "East Window 2": "Prm Zone 2 East Wall Window 2",
        ...
        self.assertEqual(
            {
                ...
                "Core Space 1 Slab on Grade": "Core Zone 1 Floor",
                "Core Zone": "Core Zone 1",
                "Core Zone MainTerminal": "RPD_Test_System_11.1_VAV_SZ - Terminal for Core Zone 1",
                "East Door 1": "Prm Zone 2 East Wall Door 1",
                "East Window 1": "Prm Zone 2 East Wall Window 1",
                "East Window 2": "Prm Zone 2 East Wall Window 2",
                "Exterior Wall Type 1": "Exterior Wall 1",
        ...
        self.assertEqual(
            {
                ...
                "Core Space 1 Slab on Grade": "Core Zone 1 Floor",
                "Core Zone": "Core Zone 1",
                "Core Zone MainTerminal": "RPD_Test_System 12_CAV_SZ_HW - Terminal for Core Zone 1",
        ...
        self.assertEqual(
            {
                ...
                "Core Space 1 Slab on Grade": "Core Zone 1 Floor",
                "Core Zone": "Core Zone 1",
                "Core Zone MainTerminal": "RPD_Test_System 13_CAV_SZ_ER - Terminal for Core Zone 1",
                "East Door 1": "Prm Zone 2 East Wall Door 1",
                "East Window 1": "Prm Zone 2 East Wall Window 1",
                "East Window 2": "Prm Zone 2 East Wall Window 2",
                "Exterior Wall Type 1": "Exterior Wall 1",
        ...
        self.assertEqual(
            {
                ...
                "Core Space 1 Slab on Grade": "Core Zone 1 Floor",
                "Core Zone 1": "Core Zone 1",
                "Core Zone 1 MainTerminal": "RPD_Test_System_P_FCU_purchased - Terminal for Core Zone 1",
                "East Door 1": "Prm Zone 2 East Wall Door 1",
                "East Window 1": "Prm Zone 2 East Wall Window 1",
                "East Window 2": "Prm Zone 2 East Wall Window 2",
                "Exterior Wall Type 1": "Exterior Wall 1",
        ...
        self.assertEqual(
            {
                ...
                "Core Space 1 Slab on Grade": "Core Zone 1 Floor",
                "Core Zone 1": "Core Zone 1",
                "Core Zone 1 MainTerminal": "RPD_Test_System_P_WSHP - Terminal for Core Zone 1",
                "East Door 1": "Prm Zone 2 East Wall Door 1",
                "East Window 1": "Prm Zone 2 East Wall Window 1",
                "East Window 2": "Prm Zone 2 East Wall Window 2",
                "Exterior Wall Type 1": "Exterior Wall 1",
        ...
        self.assertEqual(
            {
                ...
                "Core Space 1 Slab on Grade": "Core Zone 1 Floor",
                "Core Zone 1": "Core Zone 1",
                "Core Zone 1 DOASTerminal": "RPD_Test_System_P_WSHP_DOAS - Terminal for Core Zone 1",
                "Core Zone 1 MainTerminal": "RPD_Test_System_P_WSHP_no_OA - Terminal for Core Zone 1",
