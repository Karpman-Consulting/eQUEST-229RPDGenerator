...
class DisclaimerWindow(ctk.CTkToplevel):
    def __init__(self, *args, **kwargs):
        ...
        disclaimer_label = ctk.CTkLabel(self, text="Disclaimer Notice", anchor="w", font=("Helvetica", 20, "bold"))
        disclaimer_label.pack(fill='x', padx=10, pady=(10, 0))

        # Disclaimer and acknowledgment text without "Disclaimer Notice\n\n"
        disclaimer_text = ("Acknowledgment: This material is based upon work supported by the U.S. Department of Energy’s Office of Energy Efficiency and Renewable Energy (EERE) under the Building Technologies Office - DE-FOA-0002813 - Bipartisan Infrastructure Law Resilient and Efficient Codes Implementation.\n\n"
